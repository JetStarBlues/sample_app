  	...
  	describe "failure" do
  		it "should not make a new user" do
  			lambda do
	  			...
	  			response.should have_selector('div#errorMessage')  #id
  ...
  describe "signin" do
  	describe "failure" do
  		it "should not sign in a user" do		
			...
			#response.should have_selector('div.flash.error', :content => "Invalid") #checks to see if contains word/phrase 'Invalid' 
